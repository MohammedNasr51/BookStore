<footer class="bg-dark text-center text-lg-start text-white mb-0 w-100">
    <!-- Grid container -->
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-v4-rtl/4.1.1-1/js/bootstrap.bundle.min.js"
    integrity="sha512-5LQcfkpkY3H6HduPyJ9ogeSCnwucwzTdYC/cFvk+SHdFrsfIXtlhaJRwf3G551XNHW+WTUEIWDgGX+a4kchU2w=="
